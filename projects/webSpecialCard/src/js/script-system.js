...
let titleUrl = getDataUrl.get('KYhi');
...
function copyData() {
    ...
    let titleCopy = document.getElementsByClassName('titleCopy')[0];
    ...
    titleCopy.value = document.getElementById('KYhi').value;
    // if
...
// output
let titleValue = document.getElementsByClassName('titleData')[0]; 
// jika class receiverData ada (mencegah errior)
if(titleValue){
    titleValue.innerHTML = titleUrl;
